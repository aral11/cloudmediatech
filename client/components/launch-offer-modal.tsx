    ...
    <>
      ...
      >
        <div className="relative rounded-2xl bg-white dark:bg-slate-900 shadow-2xl overflow-hidden border border-gray-200 dark:border-slate-700">
          ...
          <button
            onClick={handleClose}
            className="absolute right-4 top-4 z-10 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors"
          ...
          <div className="p-6 sm:p-8">
            ...
            {/* Value Line */}
            <div className="flex flex-wrap gap-2 mb-8 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              <Button
                className="w-full bg-tech-500 hover:bg-tech-600 text-white font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg shadow-md hover:shadow-lg transition-all"
                onClick={() => {
                  window.open(
              ...
              <Button
                variant="outline"
                className="w-full font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors"
                onClick={() => {
          ...
          {/* Footer Brand Line */}
          <div className="px-6 sm:px-8 py-3 bg-tech-50 dark:bg-tech-900/30 border-t border-gray-200 dark:border-slate-700">
